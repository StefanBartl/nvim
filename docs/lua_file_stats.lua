...
local function print_legend()
    ...
    print("Note: percentages in each table are computed relative to the table's totals (e.g. file's total lines or words).")
end
...
-- Text summary printed at end (unchanged but includes whitespace counts)
...
-- Argument parsing: supports many flags including --top-only variants
local root_dir = "."
