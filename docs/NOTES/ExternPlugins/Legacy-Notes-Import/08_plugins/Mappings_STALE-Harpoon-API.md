...
[Mappings](../../../../../home/steve/.config/nvim/lua/mappings.lua)

"<leader>th", "Themes"
"<leader>fk", "Finde Keymaps (Telescope)"
"<leader>fs", "Keymap-Suche via Bash-Script"

- Mit Befehlen umgehen: (MYTERM)
   "n", "<leader>to", term.open "Open terminal (bottom)"
   "n", "<leader>ts", term.set_command "Set terminal command"
   "n", "<leader>tr", term.run_command "Run terminal command"
   "n", "<leader>tc", term.clear_command "Clear terminal command"
...
| ------ | ---------------------------- | ------------------------------------------- |
| za     | Toggle Fold (open/close)     | Öffnet oder schließt aktuellen Fold         |
| zc     | Close Fold                   | Schließt aktuellen Fold, wenn möglich       |
| zo     | Open Fold                    | Öffnet aktuellen Fold, aber keine inneren   |
| zC     | Close All Folds unter Cursor | Schließt alle inneren Folds des aktuellen   |
| zO     | Open All Folds unter Cursor  | Öffnet alle inneren Folds des aktuellen     |
| zM     | Close All Folds (Mass Fold)  | Schließt alle Folds im ganzen Dokument      |
| zR     | Open All Folds (Mass Unfold) | Öffnet alle Folds im ganzen Dokument        |
| zd     | Delete Fold unter Cursor     | Entfernt den Fold dauerhaft                 |
| zE     | Delete All Folds             | Entfernt alle Folds im Dokument             |
| zm     | Reduce foldlevel um 1        | Versteckt mehr, wenn foldmethod=manual/expr |
| zr     | Erhöhe foldlevel um 1        | Zeigt mehr an                               |
