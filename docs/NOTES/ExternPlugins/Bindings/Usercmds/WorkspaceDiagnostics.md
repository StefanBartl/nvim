...
Registriert in
[lua/lsp/usercmds/workspace_diagnostics.lua]($REPOS_DIR/lsp.nvim/lua/lsp/usercmds/workspace_diagnostics.lua),
aufgerufen aus dem `config`-Block in
[lua/lsp/init.lua]($REPOS_DIR/lsp.nvim/lua/lsp/init.lua) (`M.setup`).
...
[lua/lsp/core/workspace_diagnostics.lua]($REPOS_DIR/lsp.nvim/lua/lsp/core/workspace_diagnostics.lua).
