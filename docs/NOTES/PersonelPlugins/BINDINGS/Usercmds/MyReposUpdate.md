...
([`lua/bindings/usrcmds/update_repos/`](../../../../../lua/bindings/usrcmds/update_repos/init.lua),
alongside [`:MyPlugins`](./MyPlugins.md) and [`:WhoLocks`](./WhoLocks.md)).
...
| --- | --- | --- |
| What it touches | only the repos named in [`plugins.personal.list`](../../../../../lua/plugins/personal/list.lua) | *every* git repo it finds under the directory |
