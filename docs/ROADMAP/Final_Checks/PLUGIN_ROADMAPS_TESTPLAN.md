...
## Table of content
  ...
  - [`hover.nvim`](#hovernvim)
    - [1. Kommt die Übersetzung überhaupt an?](#1-kommt-die-übersetzung-überhaupt-an)
  ...
  - [`documentation.nvim` / `runtime-analysis.nvim`](#documentationnvim--runtime-analysisnvim)
    ...
    - [M17/M10 · Laufzeit-Evidenz unterdrückt `unreferenced-module`](#m17m10--laufzeit-evidenz-unterdrückt-unreferenced-module)
  ...
  - [`color_my_ascii.nvim`](#color_my_asciinvim)
    - [Öffentliche Highlight-API (aus L4)](#öffentliche-highlight-api-aus-l4)
  - [`gopath.nvim` / `pickers.nvim` / `lib.nvim`](#gopathnvim--pickersnvim--libnvim)
    - [M9 · Frecency für Alternate-Vorschläge](#m9--frecency-für-alternate-vorschläge)
    - [M16 · `deps.health`-Migration](#m16--depshealth-migration)
  - [nvim-config](#nvim-config)
    - [M5 · Sprung zur umschließenden Struktur](#m5--sprung-zur-umschließenden-struktur)
    - [A · Source-Achse von `:Bindings check`](#a--source-achse-von-bindings-check)
  - [Nicht von Hand prüfbar — und was stattdessen gilt](#nicht-von-hand-prüfbar--und-was-stattdessen-gilt)
