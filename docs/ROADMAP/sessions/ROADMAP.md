...
2. OpenInNvim new instance startet zwar eine neue instanz, aber ladet dann nicht das dokument. CWD ist aber korrekt! Und Linux version ist noch nicht implementiert.
3. Bei `SessionSave` schließt es den Neotree sofern offen. Auch bei anderen usercomands von 'session'?
