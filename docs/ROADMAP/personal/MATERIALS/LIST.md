...
```bash
repos=("buffer-ctx.nvim" "cascade,nvim" "color_my_ascii.nvim" "dap.nvim" "debugging.nvim" "diff.nvim" "emojis.nvim" "fileops.nvim" "filetree.nvim" "github_stats.nvim" "gopath.nvim" "insights.nvim" "language.nvim" "lib.nvim" "markdown.nvim" "mdview.nvim" "migrate.nvim" "cmdlog.nvim" "sandbox.nvim" "open.nvim" "pdfport.nvim" "pickers.nvim" "insights.nvim" "recommender.nvim" "replacer.nvim" "reposcope.nvim" "sessions.nvim" "spotlight.nvim"); for repo in "${repos[@]}"; do rm -rf "$repo"; done
