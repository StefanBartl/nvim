...
```bash
repos=("/buffer-ctx.nvim" "/cascade,nvim" "/color_my_ascii.nvim" "/debugging.nvim" "/dap.nvim" "/diff.nvim" "/documentation.nvim" "/emojis.nvim" "/fileops.nvim" "/filetree.nvim" "/github_stats.nvim" "/gopath.nvim" "/insights.nvim" "/language.nvim" "/lib.nvim" "/markdown.nvim" "/mdview.nvim" "/migrate.nvim" "/mygrep.nvim" "/cmdlog" "/sandbox.nvim" "/open.nvim" "/pdfport.nvim" "/pickers.nvim" "/insights.nvim" "/recommender.nvim" "/replacer.nvim" "/reposcope.nvim" "/sessions.nvim" "/spotlight.nvim" ); for repo in "${repos[@]}"; do clean_repo=${repo#/}; git clone "git@github.com:StefanBartl/${clean_repo}.git"; done
...
```powershell
@("buffer-ctx.nvim", "cascade,nvim", "color_my_ascii.nvim", "debugging.nvim", "dap.nvim", "diff.nvim", "documentation.nvim", "emojis.nvim", "fileops.nvim", "filetree.nvim",  "github_stats.nvim", "gopath.nvim", "insights.nvim", "language.nvim", "lib.nvim", "markdown.nvim", "mdview.nvim", "migrate.nvim", "cmdlog.nvim", "sandbox.nvim", "open.nvim", "pdfport.nvim", "pickers.nvim", "insights.nvim", "recommender.nvim", "replacer.nvim", "reposcope.nvim", "sessions.nvim", "spotlight.nvim" ) | ForEach-Object { git clone "https://github.com/StefanBartl/$_.git" }
```
...
```powershell
@("buffer-ctx.nvim", "cascade,nvim", "color_my_ascii.nvim", "debugging.nvim", "dap.nvim", "diff.nvim", "documentation.nvim", "emojis.nvim", "fileops.nvim", "filetree.nvim",  "github_stats.nvim", "gopath.nvim", "insights.nvim", "language.nvim", "lib.nvim", "markdown.nvim", "mdview.nvim", "migrate.nvim", "cmdlog.nvim", "sandbox.nvim", "open.nvim", "pdfport.nvim", "pickers.nvim", "insights.nvim", "recommender.nvim", "replacer.nvim", "reposcope.nvim", "sessions.nvim", "spotlight.nvim") | ForEach-Object { if (Test-Path $_) { Remove-Item $_ -Recurse -Force } }
...
```bash
repos=("buffer-ctx.nvim" "cascade,nvim" "color_my_ascii.nvim" "dap.nvim" "debugging.nvim" "diff.nvim" "documentation.nvim" "emojis.nvim" "fileops.nvim" "filetree.nvim" "github_stats.nvim" "gopath.nvim" "insights.nvim" "language.nvim" "lib.nvim" "markdown.nvim" "mdview.nvim" "migrate.nvim" "cmdlog.nvim" "sandbox.nvim" "open.nvim" "pdfport.nvim" "pickers.nvim" "insights.nvim" "recommender.nvim" "replacer.nvim" "reposcope.nvim" "sessions.nvim" "spotlight.nvim"); for repo in "${repos[@]}"; do rm -rf "$repo"; done
