...
Feedback: Es wöre aber super, wenn jemadn fieltree.nvim verwendet und neotreee als enginde benutzt, dass man dann in der filetree.nvim user config (spec) die sources einfach enablen/disablen kann
