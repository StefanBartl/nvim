...
--- @param state Cfg.NeoTree.State|string|nil  -- may be a state table or a direct source name
...
--- @param state Cfg.NeoTree.State|string|nil  -- state table or explicit source name
