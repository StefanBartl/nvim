# CDX-Kommentar-Sweep — Archiv abgeschlossener Häppchen

Vollständige Fund-Protokolle der **abgeschlossenen** Häppchen 1–33 des
CDX-Kommentar-Sweeps (siehe [Handover](../../../../handovers/cdx-comment-sweep.md)
für Ziel, Regeln, aktuellen Stand und die noch laufende Arbeit). Hierher
ausgelagert, damit das Handover nicht bei jeder Fortsetzung tausende Zeilen
bereits erledigter Funde mitschleppen muss — im Handover selbst steht nur
noch ein Ein-Zeiler pro Häppchen mit Verweis hierher.
