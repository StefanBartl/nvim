...
Autorenwunsch gestartet und läuft über **21 von 32 Repos** (alphabetisch;
Runden 1–7 zu 3 parallelen Agenten, danach ein Repo pro Durchgang). **14
...
ein Repo pro Durchgang. Offen bleiben die restlichen 10 Repos für `SEC-*`
