...
1. local funktionen attt wexporieren wenn keine externe Referenz! Alle files durchgehen!
...
5. Alle mappings, autocmds und usercommand funktionen beiu Gelegenheit von `setup()` auf `attach()` umschreiben
