...
- [x] **`wkdbook-casedesk` angelegt** — `wkdbook-myplugins/casedesk.nvim/`
      mit `../../personal/All/FINISH/ERLEDIGT/README-New/README.md`, `ROADMAP/`, `Messungen/`. Committet und gepusht.
...
- `../../personal/All/FINISH/ERLEDIGT/README-New/README.md` englisch mit ASCII-Art, Badges, Schwesterplugin-Absatz
