...
**Eight open; puppeteer → cascade, minty → ui.colorpicker and colorizer → my.nvim done 2026-09-19.**
...
| **ui.nvim** | matchup offscreen status · ~~ts-context~~ (B5, as `ui.context`, a float — not the winbar) · which-key popup · ~~minty colour picker~~ (`ui.colorpicker`, 2026-09-19) · zen mode |
