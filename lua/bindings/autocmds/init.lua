...
require("bindings.autocmds.auto-center-fexplorer").setup()
...
require("bindings.autocmds.explorer-singleton").setup()
...
require("bindings.autocmds.markdown_folds").setup()
...
require("bindings.autocmds.general").enable({
  cursorline = {
...
local ok_g, git = pcall(require, "bindings.autocmds.git")
if ok_g then
  git.enable(true)
end
...
require("bindings.autocmds.text").enable({
  trim_trailing = {
