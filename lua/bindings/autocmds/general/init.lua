---@module 'bindings.autocmds.general'
...
local helpers = require("bindings.autocmds.general.helpers")
local DEFAULTS = require("bindings.autocmds.general.defaults").get_defaults()
...
function M.enable(cfg)
  ...
  -- bindings.autocmds.text's own last_loc feature. Never actually double-fired --
  ...
  -- weight. Removed 2026-09-12; bindings.autocmds.text is the one owner now (native
