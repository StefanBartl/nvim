---@meta
---@module 'bindings.autocmds.git.@types'
...
--- It mirrors the shape expected by `require('bindings.autocmds.git').enable(cfg)`.
...
--------------------------------------------------------------------------------
-- Root configuration passed to `require('bindings.autocmds.git').enable(cfg)`
--------------------------------------------------------------------------------
