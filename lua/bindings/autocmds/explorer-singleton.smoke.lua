---@module 'bindings.autocmds.explorer-singleton.smoke'
...
--   nvim --headless -u NONE -l lua/bindings/autocmds/explorer-singleton.smoke.lua
...
local root = vim.fn.fnamemodify(this, ":p:h:h:h") -- lua/bindings/autocmds/… -> repo root
...
package.loaded["bindings.autocmds.explorer-singleton"] = nil
local coordinator = require("bindings.autocmds.explorer-singleton")
coordinator.setup()
