---@module 'bindings.autocmds.terminals'
...
--- Enable with `require('bindings.autocmds.terminals').enable(cfg)`.
...
local DEFAULTS = require("bindings.autocmds.terminals.defaults").get_defaults()
