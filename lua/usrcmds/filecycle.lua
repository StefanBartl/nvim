...
---
--- Builtin alternative:
---   :args %:p:h/*     -- set arglist to all files in current file's directory
---   :next / :previous -- move within that list

-- -- lazy:
-- {
--   dir = vim.fn.stdpath("config") .. "/lua/utils", -- falls lokal,
--   name = "utils-nextprev",
--   lazy = true,
--   config = function()
--     require("utils.nextprev").setup({
--       include_hidden = false,
--       wrap = true,
--       root = "buffer_dir",        -- or "cwd"
--       confirm_on_modified = true, -- use :confirm edit on changed buffers
--       case_insensitive = true,
--     })
--   end,
--   keys = {
--     { "<leader>nf", function() require("utils.nextprev").open("next") end, desc = "[NextPrev] Next file" },
--     { "<leader>pf", function() require("utils.nextprev").open("prev") end, desc = "[NextPrev] Previous file" },
--   },
