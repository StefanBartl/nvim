  ...
  -- Copy / Path operations
  {
    ...
    items = {
      ...
      },
      {
        key = "[t",
        enabled = true,
        label = "Copy recursive file list (abs)",
        icon = "󰈙",
        rtxt = "[t]",
        node_type = "any",
      },
      {
        key = "[T",
        enabled = true,
        label = "Copy recursive file list (rel)",
        icon = "󰈙",
        rtxt = "[T]",
        node_type = "any",
      },
    ...
    items = {
      {
        key = "w",
        enabled = true,
        label = "Resize window (toggle small/normal/large)",
        icon = "󰣇",
        rtxt = "w",
        node_type = "any",
      },
    ...
    items = {
      {
        key = "O",
        enabled = true,
        label = "Open with System Application",
        icon = "",
        rtxt = "O",
        node_type = "any",
      },
      { key = "M", enabled = true, label = "Open in system file manager", icon = "", rtxt = "M", node_type = "any" },
      {
        key = "+",
        enabled = true,
        label = "Set Neovim cwd to node and focus Neo-tree",
        icon = "",
        rtxt = "+",
        node_type = "any",
      },
    ...
    items = {
      {
        key = "grep",
        enabled = true,
        label = "Live grep in node directory",
        icon = "",
        rtxt = "grep",
        node_type = "folder",
      },
