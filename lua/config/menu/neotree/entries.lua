...
local entries = {
  ...
  { key = "?", enabled = true, label = "Show help", icon = "?", rtxt = "?" },
  {
    key = "<Esc>",
    enabled = true,
    label = "Clear search/filter/preview/quarantine",
    icon = "󰌑",
    rtxt = "<Esc>",
  },
  ...
  { key = "W", enabled = true, label = "Open with window picker", icon = "", rtxt = "W" },
  {
    key = "w",
    enabled = true,
    label = "Resize window (cycle small/normal/large)",
    icon = "󰣇",
    rtxt = "w",
  },
  ...
  -- ============================================================================
  {
    key = "<C-s>",
    enabled = true,
    label = "Force-save last normal buffer",
    icon = "💾",
    rtxt = "<C-s>",
  },
  {
  ...
  },
  {
    key = "<PageDown>",
    enabled = true,
    label = "Scroll preview down (page)",
    icon = "",
    rtxt = "<PageDown>",
  },
  ...
  -- ============================================================================
  {
    key = "c",
    enabled = true,
    label = "Copy marked/current to clipboard",
    icon = "󰈙",
    rtxt = "c",
  },
  {
    key = "x",
    enabled = true,
    label = "Cut marked/current to clipboard",
    icon = "✂️",
    rtxt = "x",
  },
  ...
  -- ============================================================================
  {
    key = "+",
    enabled = true,
    label = "Navigate into directory (set root)",
    icon = "",
    rtxt = "+",
  },
  ...
  { key = "]f", enabled = true, label = "Copy file list (relative)", icon = "󰈙", rtxt = "]f]" },
  {
    key = "[F",
    enabled = true,
    label = "Copy folder list (absolute)",
    icon = "󰈙",
    rtxt = "[F]",
  },
  {
    key = "]F",
    enabled = true,
    label = "Copy folder list (relative)",
    icon = "󰈙",
    rtxt = "]F]",
  },
