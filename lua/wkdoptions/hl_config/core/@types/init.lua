...
---@field get_augroup fun(name: string, clear: boolean|nil): integer # Get or create augroup handle (cached, idempotent, prefixed with "myopt_", clear defaults to true)
