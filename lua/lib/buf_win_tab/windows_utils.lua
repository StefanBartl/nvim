...
function M.list_all_buffers_info()
  ...
  for i = 1, #bufs do
    ...
    local entry = {
      ...
      filetype = (b.variables and b.variables.ft) or vim.api.nvim_buf_get_option(b.bufnr or -1, "filetype") or "",
      buftype = b.buftype or vim.api.nvim_buf_get_option(b.bufnr or -1, "buftype") or "",
      modified = vim.api.nvim_buf_get_option(b.bufnr or -1, "modified"),
      size = b.size or 0,
    }
    out[#out + 1] = entry
  end
