...
Dein Modul `lib.fs.polymorphic_root_resolver` liefert eine **funktionale, polymorphe Root-Ermittlung**:

```lua
local resolver_module = require("lib.fs.polymorphic_root_resolver")
