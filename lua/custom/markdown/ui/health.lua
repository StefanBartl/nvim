...
local function Hstart(msg)
  if has_api10 then vim.health.report_start(msg) else vim.health.start(msg) end
end
local function Hok(msg)
  if has_api10 then vim.health.report_ok(msg) else vim.health.ok(msg) end
end
local function Hwarn(msg)
  if has_api10 then vim.health.report_warn(msg) else vim.health.warn(msg) end
end
