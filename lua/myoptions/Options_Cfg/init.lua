---@module 'myoptions.Options_Cfg'
--- Editor option toggles & global behaviors which are not purely visual
--- highlight groups:
---   * cursorline/column defaults (cooperate with Highlight_Cfg)
...
local function after_set(key)
	...
	if key == "enable_line" or key == "enable_column" or key == "map_cursor_to_hl" or key == "enable_insert_submode_colors" then
...
local function enable()
	...
	require("myoptions.commands").register_options_commands({
