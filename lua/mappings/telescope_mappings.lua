...
function M.setup()
  ...
  map("n", "<leader>tkey", "<cmd>Telescope keymaps<CR>", { desc = "[Telescope] Find keymaps" })
  map("n", "<leader>tb", "<cmd>Telescope buffers<CR>", { desc = "[Telescope] Buffers" })
  map("n", "<leader>fhelp", "<cmd>Telescope help_tags<CR>", { desc = "[Telescope] Help" })
  ...
  map("n", "<leader>tcm", "<cmd>Telescope git_commits<CR>", { desc = "[Telescope] Git Commits" })
